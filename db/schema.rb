...
ActiveRecord::Schema.define(version: 2018_06_07_183519) do
  ...
  create_table "user_events", force: :cascade do |t|
    ...
    t.index ["activity_id"], name: "index_user_events_on_activity_id"
  ...
  add_foreign_key "user_events", "activities"
